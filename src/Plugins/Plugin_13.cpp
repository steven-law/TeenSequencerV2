...
void Plugin_13::set_voice_waveform(uint8_t XPos, uint8_t YPos)
{
    if (enc_moved[XPos])
    {
        int reworkWaveform;
        reworkWaveform = get_Potentiometer(XPos, YPos);
...
void Plugin_13::set_filter_frequency(uint8_t XPos, uint8_t YPos)
{
    if (enc_moved[XPos])
    {
...
void Plugin_13::set_filter_resonance(uint8_t XPos, uint8_t YPos, float min, float max)
{
    if (enc_moved[XPos])
    {
...
void Plugin_13::set_filter_sweep(uint8_t XPos, uint8_t YPos)
{
    if (enc_moved[XPos])
    {
...
void Plugin_13::set_filter_type(uint8_t XPos, uint8_t YPos)
{
    if (enc_moved[XPos])
    {
