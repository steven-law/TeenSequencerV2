...
void Plugin_10::set_voice_waveform(uint8_t XPos, uint8_t YPos)
{
    if (enc_moved[XPos])
    {
        assign_voice_waveform(get_Potentiometer(XPos, YPos));
    }
}
...
void Plugin_10::set_voice_amplitude(uint8_t XPos, uint8_t YPos)
{
    if (enc_moved[XPos])
    {
...
void Plugin_10::set_filter_frequency(uint8_t XPos, uint8_t YPos)
{
    if (enc_moved[XPos])
    {
...
void Plugin_10::set_filter_resonance(uint8_t XPos, uint8_t YPos, float min, float max)
{
    if (enc_moved[XPos])
    {
...
void Plugin_10::set_filter_sweep(uint8_t XPos, uint8_t YPos)
{
    if (enc_moved[XPos])
    {
...
void Plugin_10::set_filter_type(uint8_t XPos, uint8_t YPos)
{
    if (enc_moved[XPos])
    {
...
void Plugin_10::set_envelope_attack(uint8_t XPos, uint8_t YPos, int max)
{
    if (enc_moved[XPos])
    {
        assign_envelope_attack(get_Potentiometer(XPos, YPos), max);
    }
}
void Plugin_10::set_envelope_decay(uint8_t XPos, uint8_t YPos, int max)
{
    if (enc_moved[XPos])
    {
        assign_envelope_decay(get_Potentiometer(XPos, YPos), max);
    }
}
void Plugin_10::set_envelope_sustain(uint8_t XPos, uint8_t YPos)
{
    if (enc_moved[XPos])
    {

        assign_envelope_sustain(get_Potentiometer(XPos, YPos) / MIDI_CC_RANGE_FLOAT);
    }
}
void Plugin_10::set_envelope_release(uint8_t XPos, uint8_t YPos, int max)
{
    if (enc_moved[XPos])
    {
